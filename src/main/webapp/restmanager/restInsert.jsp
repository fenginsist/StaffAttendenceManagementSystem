...
<body>
<form action="/rest?method=addRest" method="post">
  <div class="place">
    <span>位置：</span>
    <ul class="placeul">
      <li><a href="/rest?method=toRestSearch">休假管理</a></li>
  ...
  <div class="formbody">
    ...
    <ul class="forminfo">
      <li>
        <label>工号</label>
        </label><input type="text" name="account" class="dfinput" value="10001" readonly="readonly"/>
      </li>
      <li>
        <label>姓名</label>
        </label><input type="text" name="name" class="dfinput" value="admin" readonly="readonly"/>
      </li>
      <li>
      ...
      <li><label>&nbsp;</label><input name="" type="submit" class="btn" value="确认保存" /></li>   <%-- onclick="saveButton()" --%>
    </ul>
  </div>
</form>
</body>
